    ...
    suspend fun insertInitialQuestions() {
        ...
        if (questionDao.getAllQuestions().first().isEmpty()) {
            val initialList = listOf(
                QuestionEntity(
                    qId = "Q1",
                    qText = "Kitaplar benim için çok önemlidir.",
                    primaryId = "A",
                    s1Id = "G",
                    s1w = 0.2f,
                    s2Id = "",
                ...
                QuestionEntity(
                    "Q7",
                    "Doğa ile başbaşa olmayı severim.",
                    "H",
                    "O",
                    0.2f,
                    "E",
                ...
                QuestionEntity(
                    "Q12",
                    "Yürüyüş yapma, koşma, yüzme gibi bireysel sporlar yerine futbol, basketbol ve voleybol gibi takım sporlarını tercih ederim.",
                    "F",
                    "E",
                    0.2f,
                    "I",
                ...
                QuestionEntity(
                    "Q18",
                    "Bir sorunum olduğunda tek başıma çözmeye çalışmak yerine yardımına başvurabileceğim birini ararım.",
                    "F",
                    "O",
                    0.2f,
                    "",
                ...
                QuestionEntity(
                    "Q22",
                    "Eğer... ise ne olur' türünde deneysel şeyler yapmayı severim.",
                    "J",
                    "H",
                    0.2f,
                    "E",
                ...
                QuestionEntity(
                    "Q25",
                    "En iyi fikirlerin içime doğduğu anlar yürüyüş, koşu gibi fiziksel etkinlikte bulunduğum zamanlardır.",
                    "E",
                    "G",
                    0.2f,
                    "B",
                ...
                QuestionEntity(
                    "Q27",
                    "Kuş beslemek, akvaryum sahibi olmak gibi beni doğa ile irtibatlandıran en az bir hobim vardır.",
                    "H",
                    "M",
                    0.2f,
                    "",
                ...
                QuestionEntity(
                    "Q28",
                    "Dil sürçmeleri, tekerlemeler veya kafiyeli sözcüklerle eğlenmeyi severim.",
                    "I",
                    "D",
                    0.2f,
                    "C",
                ...
                QuestionEntity(
                    "Q29",
                    "Zihnim sürekli eşya ile ilgili kalıp, kural ve mantıksal silsileleri araştırmakla meşguldür.",
                    "J",
                    "K",
                    0.2f,
                    "",
                ...
                QuestionEntity(
                    "Q32",
                    "Boş zamanlarımı genellikle dışarıda geçirmek isterim.",
                    "M",
                    "H",
                    0.2f,
                    "",
                ...
                QuestionEntity(
                    "Q34",
                    "Hayatla ilgili sürekli zihnimi meşgul eden bazı konular vardır.",
                    "G",
                    "P",
                    0.2f,
                    "",
                ...
                QuestionEntity(
                    "Q35",
                    "Kafam mevsimler, iklimler gibi doğal olayların oluşumu ile ilgili sorularla meşguldür.",
                    "P",
                    "B",
                    0.2f,
                    "",
                ...
                QuestionEntity(
                    "Q36",
                    "Konuşurken (veya yazdığımda) insanlar bazen kullandığım kelimelerin ne anlama geldiğini sorarlar.",
                    "I",
                    "J",
                    0.2f,
                    "",
                ...
                QuestionEntity(
                    "Q37",
                    "Bilimsel alandaki gelişmeler ilgimi çeker.",
                    "B",
                    "P",
                    0.2f,
                    "",
                ...
                QuestionEntity(
                    "Q40",
                    "Konuşurken sıklıkla el kol hareketi yapar veya diğer çeşit beden dillerini kullanırım.",
                    "M",
                    "F",
                    0.2f,
                    "I",
                ...
                QuestionEntity(
                    "Q42",
                    "Zayıf ve kuvvetli yönlerim hakkında gerçekçi bir bakış açısına sahibim.",
                    "O",
                    "B",
                    0.2f,
                    "",
                ...
                QuestionEntity(
                    "Q44",
                    "Her şeyin mutlaka mantıklı bir açıklaması olduğuna inanırım.",
                    "J",
                    "P",
                    0.2f,
                    "",
                ...
                QuestionEntity(
                    "Q47",
                    "Geometri gibi şekillerle ilgili konuları cebir gibi işlemsel konulardan daha kolay bulurum.",
                    "K",
                    "J",
                    0.2f,
                    "",
